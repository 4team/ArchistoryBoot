...
public class RouteVO implements Serializable{
	...
	private boolean secret; //nullê°??Š¥
	private boolean step;
	private String password; //nullê°??Š¥
	private double lat; //nullê°??Š¥
	private double lng; //nullê°??Š¥
	private Date regdate; //nullê°??Š¥
	private Date updatedate; //nullê°??Š¥	
